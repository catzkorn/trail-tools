...
type BloodLactateMeasure struct {
	...
	MmolPerLiter float64                `protobuf:"fixed64,3,opt,name=mmol_per_liter,json=mmolPerLiter,proto3" json:"mmol_per_liter,omitempty"`
...
func (x *BloodLactateMeasure) GetMmolPerLiter() float64 {
	if x != nil {
...
type CreateBloodLactateMeasureRequest struct {
	...
	MmolPerLiter float64 `protobuf:"fixed64,2,opt,name=mmol_per_liter,json=mmolPerLiter,proto3" json:"mmol_per_liter,omitempty"`
...
func (x *CreateBloodLactateMeasureRequest) GetMmolPerLiter() float64 {
	if x != nil {
		return x.MmolPerLiter
	}
	return 0
...
var file_athletes_v1_athletes_proto_rawDesc = []byte{
	...
	0x28, 0x01, 0x52, 0x0c, 0x6d, 0x6d, 0x6f, 0x6c, 0x50, 0x65, 0x72, 0x4c, 0x69, 0x74, 0x65, 0x72,
	...
	0x01, 0x52, 0x0c, 0x6d, 0x6d, 0x6f, 0x6c, 0x50, 0x65, 0x72, 0x4c, 0x69, 0x74, 0x65, 0x72, 0x12,
